...
regulation-based operation`, 
    ...
    'contact.address.value': '(336822)170-6, Sinbong-ri, Yeongin-myeon, Asan-si, Chungcheongnam-do, South Korea',
    'contact.phone.value': '+82-10-3397-9023',
    'contact.email.value': 'hs.lee@ihubglobal.co.kr',
...
ビジネス、情報、システムをスマートにつなぐ「ハブ」としての役割を担います。`,
    ...
    'contact.address.value': '(336822)忠清南道牙山市霊仁面新峰里170-6',
    'contact.phone.value': '+82-10-3397-9023',
    'contact.email.value': 'hs.lee@ihubglobal.co.kr',
